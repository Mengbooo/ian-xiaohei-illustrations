...
纯白、极简、手绘、留白、克制、怪诞、产品草图感、中文手写感、结构清楚但不说明书。Bemo 保留样图里的蓝发、绿色 hoodie 和开发者气质。
...
- Bemo 必须参考用户传入或内置样图；不要改成黑色小怪物、通用动漫角色或真人。

## 颜色

- 黑色：主体线稿、角色、框线、结构、主要文字、主体物件。
- Bemo 色：蓝发、绿色 hoodie、肤色、蓝白鞋和代码/电脑蓝色可保留。
- 品牌蓝 `#012fe3`：重点批注、问题、情绪点、关键提醒、结果。不要再用红色表达这类语义。
- 橙色：主流程、路径、箭头、自动化流向、从 A 到 B 的移动关系。
- 品牌绿 `#01c193`：补充说明、脑内状态、系统状态、第二层解释、AI/assistant/自动化提示。不要再用普通蓝色表达这类语义。

品牌绿不是每张都必须用。颜色要克制，宁可少不要多。
