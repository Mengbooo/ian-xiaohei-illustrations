...
description: 生成 Bemo 角色风格的中文正文配图。用于用户要求为中文文章、帖子、博客、Notion 文档、工作流文档、方法论、流程、结构、状态、隐喻或观点生成“怪诞”“个人品牌”“Bemo”“蓝发绿 hoodie”“手绘”“正文配图”“文章插图”“配图建议”“shot list”“去标题/改图”等任务；优先使用用户传入的品牌样图，未传入时使用内置 Bemo 参考图，输出纯白手绘、品牌蓝/橙色/品牌绿批注、简洁清爽但天马行空的视觉风格。
---
...
- `references/brand-character.md`：Bemo 的形象、性格、动作库和禁忌。
...
- 纯白背景
- 黑色手绘线稿
- 少量品牌蓝 `#012fe3` / 橙色 / 品牌绿 `#01c193` 中文手写批注
- 大量留白
- Bemo 作为核心动作主体，并参考用户传入或内置品牌样图
