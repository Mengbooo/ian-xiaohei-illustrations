...
description: 生成个人品牌角色风格的中文正文配图。用于用户要求为中文文章、帖子、博客、Notion 文档、工作流文档、方法论、流程、结构、状态、隐喻或观点生成“怪诞”“个人品牌”“品牌角色”“蓝发绿 hoodie”“手绘”“正文配图”“文章插图”“配图建议”“shot list”“去标题/改图”等任务；优先使用用户传入的品牌样图，未传入时使用内置品牌角色参考图，输出纯白手绘、少量红橙蓝批注、简洁清爽但天马行空的视觉风格。
---
...
默认视觉 IP 是用户个人品牌角色：蓝发、绿色 hoodie、开发者气质、常带电脑或代码符号的二次元像素/chibi 角色。角色必须参与画面的核心动作，不能只是站在旁边当装饰。

优先使用用户随请求传入的品牌样图作为身份参考。用户没有传图时，读取内置参考：

- `assets/brand/brand-character-reference.png`
- `assets/brand/brand-character-sheet.png`
...
- `references/brand-character.md`：个人品牌角色的形象、性格、动作库和禁忌。
